...
%%
clear
load('/Volumes/ByungHun4TB/Cohen_lab_Data/20230408_BU_BHLm026/20230514_Adaptation_result_BHLm2526.mat')
...
g=1;
for i=1:size(y,2)
    bw=bwlabel(Result{y(1,i),y(2,i)}.blue>0);
    ramp=find(bw==max(bw));
    tr=[tr; Result{y(1,i),y(2,i)}.traces(1,ramp(end)+[-3883:0])];
    sp=[sp; Result{y(1,i),y(2,i)}.spike(1,ramp(end)+[-3883:0])];
    g=g+1;
end

show_traces_spikes(tr,sp,Result{118,1}.blue(ramp(end)+[-3883:0]));
%%
