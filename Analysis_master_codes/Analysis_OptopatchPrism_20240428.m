...
for j = 1:length(times)
    ...
    axis off
    text(2,20,[num2str(times(j)+1.3) 'ms'], 'FontSize', 20, 'color', [0.99 0.99 0.99])% the value 1. is to adjust timing by eyes       
    pause(0.1)
