function [fitted_curves, fitted_params, intensity_corrected] = ...
    pbleach_fitexp_nobg(intensity, Nskip, Nstop)
% fitted_curves = pbleach_fitexp(intensity)
% Fits an exponential decay *WITH NO BACKGROUND* to data in each column.
% Returns the fit curve. 
