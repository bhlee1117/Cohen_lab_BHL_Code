function [Vout, CellOut, corrimg, weightimg, offsetimg] = extractVandC2d(imgs, Vin)
% Note by Phil Brooks 2/2022: This function is not fully implemented
% (CellOut not defined). It is currently identical to extractV2d. This
% should be deleted.

% [Vout, CellOut, corrimg, weightimg, offsetimg] = extractVandC2d(imgs, Vin)
% 
