function [intens, eigVals, pcImgs] = apply_clickyPCA(ROI, mov, refImg, nPCs,hideOutput)
% function [intens, eigVals, pcImgs] = apply_clickyPCA(ROI, mov, refimg, nPCs);
...
figure
imshow(refImg, [], 'InitialMagnification', 'fit'); hold on;
xv = ROI(:,1);
yv = ROI(:,2);
