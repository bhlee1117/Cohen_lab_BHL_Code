function [roi_points] = ROIselect_instruct(movie_in, refimg, instruct)
% function [roi_points] = ROIselect(movie_in, refimg);
% movie_in: input movie.
% refimg: image (black and white or color) on which to click to
% instruct: string, instructions for user.
% select ROIs.
...
if nargin == 1;
    ...
    instruct = 'no instructions entered';
elseif nargin == 2
    instruct = 'no instructions entered';
    subplots = 2;
