function [Vout, corrimg, weightimg, offsetimg] = extractV_low_memory(imgs, Vin)
% Older version using loops rather than repmat. Runs more slowly but uses less memory.
