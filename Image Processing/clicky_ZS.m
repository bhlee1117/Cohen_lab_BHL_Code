function [roi_points, intens] = clicky_ZS(movie_in, refimg,total_int_flag);
% function [roi_points, intens] = clicky_ZS(movie_in, refimg);
...
figure
subplot(1,3,1)
imshow(refimg, [0.01,0.2], 'InitialMagnification', 'fit')
hold on;
