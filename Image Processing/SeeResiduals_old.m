...
% frame.
% 
% remOffset: Boolean variable.  If 1, add a row of 1's to the top of refSig, to
...
% size(scaleImages) = [X, Y, N], or [X, Y, N+1] if remOffset == 1, where
% the first element of scaleImages is the offset.
%
% AEC 13 May 2015
