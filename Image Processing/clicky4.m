function [roi_points, intens] = clicky4(movie_in, refimg, cmin, cmax);
% function [roi_points, intens] = clicky4(movie_in, refimg, cmin, cmax);
...
figure
subplot(3,1,1)
imshow(mat2gray(refimg), [cmin cmax], 'InitialMagnification', 'fit')
hold on;
...
intens = [];
 ...
 while(npts > 0)
  ...
  inpoly = uint16(inpolygon(x,y,xv,yv));
