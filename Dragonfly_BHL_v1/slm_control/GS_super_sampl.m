...
%     A = A.*slm_mask;
    ...
    figure(122);subplot(2,2,2);imshow(A,[]);subplot(2,2,4);imshow(abs(C),[])
...
imwrite(pic_fft_out,'C:\Program Files\Meadowlark Optics\Blink 1920 HDMI\Image Files\square_2x1_GS_super.bmp')