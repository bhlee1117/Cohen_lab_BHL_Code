function allWaves = dragonflyMultiPatWaveform_sw_2_yq(df_app)%nCells,recordFrames,maxBlueIntensity,centeredROI,exposureTime)
%
...
w_stim1.tBefore = 0.5+t_on_1; % duration off 
w_stim1.tRamp = t_on - t_on_1; % duration on
w_stim1.period = t_total; % seconds

w_stim2 = flexRampTrainWave(dt,t_total);
w_stim2.tBefore = 0.5; % duration off 
w_stim2.tRamp = t_on; % duration on
...
% w_stim3.tBefore = 0.5; % duration off 
% w_stim3.tRamp = t_on_1; % duration on
