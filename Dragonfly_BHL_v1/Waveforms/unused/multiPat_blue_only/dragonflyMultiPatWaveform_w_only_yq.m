function allWaves = dragonflyMultiPatWaveform_c_yq(df_app)%nCells,recordFrames,maxBlueIntensity,centeredROI,exposureTime)
%
...
intens = [0;df_app.BlueAmpVEditField.Value;0];
...
% w_stim2.tBefore = 0.55; % duration off 
