function allWaves = dragonflyMultiPatWaveform_c_only_yq(df_app)%nCells,recordFrames,maxBlueIntensity,centeredROI,exposureTime)
%
...
intens = [df_app.BlueAmpVEditField.Value;0;0];
