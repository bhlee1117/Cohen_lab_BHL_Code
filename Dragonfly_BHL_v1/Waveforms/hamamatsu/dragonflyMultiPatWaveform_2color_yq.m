...
% v_blue              = df_app.AOTFAmpVEditField.Value;
...
% w_ramp.tRamp = 0.4;
% 
% w_stim = [w_orange; w_const; w_ramp]*intens;
%------------end---------------------
...
% 
% w_stim = [w_orange; w_const; w_ramp_up;w_ramp_down]*intens;
%------------end---------------------
