...
w_stim1 = baseWave(dt,.5);
for amp_factor = [.1 .2 .5 1]
w_stim1 = [w_stim1 extend(baseWave(dt,.5)+1*amp_factor,1)];
end
w_ramp = rampWave(dt,5); w_ramp.tRamp = 5;
w_stim1 = [w_stim1 w_ramp];
w_stim1 = w_stim1.extend(t_total);
