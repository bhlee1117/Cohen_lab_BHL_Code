function allWaves = dragonflyMultiPatWaveform_cw_blue_cal_yq(df_app)%nCells,recordFrames,maxBlueIntensity,centeredROI,exposureTime)
%
...
w_stim1.tBefore = 0; % duration off 15
