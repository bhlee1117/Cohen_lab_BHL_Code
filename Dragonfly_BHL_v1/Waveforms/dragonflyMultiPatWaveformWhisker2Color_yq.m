function allWaves = dragonflyMultiPatWaveformWhisker2Color_yq(df_app)%nCells,recordFrames,maxBlueIntensity,centeredROI,exposureTime)
%
...
w_stim1.tBefore = 5.5; % duration off 
w_stim1.tRamp = 1; % duration on
w_stim1.period = 12; % seconds
...
w_out{7,1} = 'magnetNTrigger';
w_out{7,2} = w_ch2On;

w_out{8,1} = 'magnetPTrigger';
w_out{8,2} = w_ch1On;
% 
