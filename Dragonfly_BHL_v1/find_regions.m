...
%     figure;imshow(img,[],'initialmagnification','fit');title('adaptive histogram equalization')
end
...
%     figure;imshow(img,[],'initialmagnification','fit');title('background subtraction')
end

% median filter
if params.median_size.on
    img = medfilt2(img, [1 1]*params.median_size.value);
%     figure;imshow(img,[],'initialmagnification','fit');title('median filter')
end
...
%     figure;imshow(img,[],'initialmagnification','fit'); title('gaussian filter')
end
