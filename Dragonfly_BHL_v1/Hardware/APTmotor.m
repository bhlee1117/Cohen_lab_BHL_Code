...
%             val = uint32(0);
            ...
            movingFlag = logical(bitget(val, 5,'int64'));
            % % debug
...
%             fprintf('%d',bitget(val, 1:16,'int64')), fprintf(' ')
%             fprintf('%d',bitget(val,17:32,'int64')), fprintf('\n')
%             fprintf('%d',bitget(val,33:48,'int64')), fprintf(' ')
%             fprintf('%d',bitget(val,49:64,'int64')), fprintf('\n')
        end
    end
    methods (Static)
