function alp_patterns = dragonflySimplePatterns(dmd) % hadamard_mode)
%
...
%         sequence_mode = 'hadamard_11c3_200s_nostim'; % activity
        ...
        sequence_mode = 'simple'; % had sync
        
%             roirows = 18*10+0:55*10+3; % extended central quad 2017-12-18
%             roicols = 32*10+0:69*10+5;
            roirows = 289:481; % extended central quad 2017-12-18
            roicols = 418:609;
...
switch sequence_mode
    case 'simple'
        alp_patterns = alp_logical_to_btd(~~permute(super_mask,[3 2 1]));
