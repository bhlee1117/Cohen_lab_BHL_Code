classdef nidaq < dynamicprops
    ...
    methods (Access = private)
        function obj = nidaq(varargin)
            ...
            obj.rateConfigData = varargin{2}; % this is just a number with the approx rate of external clock input to be used
            obj.clockConfigData = varargin{3}; % cell string array of clock configuration arguments
...
%             end
    ...
    methods
        ...
        function syncStartForeground(obj) % will start and return after output is completed
            obj.syncSession.startForeground
        end
