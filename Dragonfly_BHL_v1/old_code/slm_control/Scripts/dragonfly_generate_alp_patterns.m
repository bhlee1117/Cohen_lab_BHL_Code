function alp_patterns = dragonfly_generate_alp_patterns(device,roirows,roicols,hadamard_mode)
...
%         sequence_mode = 'hadamard_11c3_200s_nostim'; % activity
        sequence_mode = 'hadamard_11c3_spotonly_once'; % had sync
end
