...
file_name_prefix  = 'M-YQ0201-7_FOV7_d1_c1_.2s_.5c_1.2V_t150ms_wt60s';
file_name_suffix = {
                    '_c'    
                    '_cw'
                    '_sw'
...
waveform_functions = {  
                        'dragonflyMultiPatWaveform_c_2_yq'
                        'dragonflyMultiPatWaveform_cw_2_yq'
                        'dragonflyMultiPatWaveform_sw_2_yq'
                        };
 
for ii=1:n_trial   
    
    cnt = 1;
    for jj = randperm(length(waveform_functions))
