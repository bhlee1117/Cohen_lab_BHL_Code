...
step=45; % Number of frames in each stack. Usally resonant scanner scans in 30 fps. Therefore, 2 sec interval btw the stacks -> 60 frm
zstack=true;
%%
...
clear order_img order
    ...
    I{1}=M2(:,:,j); I{2}=M1(:,:,j);
    s(:,:,j)=subtraction_image_ftn_cell(I,0.7); %%%subtraction
