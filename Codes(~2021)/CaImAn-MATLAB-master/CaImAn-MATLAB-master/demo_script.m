...
nam = 'H:\Image_data\OlympusTPM\20191205_jRCaMP1a\jRCAmp\Reg_1_20200109_jRCaMP_ca.tif';          % insert path to tiff stack here
...
save([pth 'Rst_' nam '.mat'],'Yr','A_or','C_or','b2','f2','Cn','options','Coor','json_file','C_df')
%% display components
