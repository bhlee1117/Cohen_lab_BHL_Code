...
% To load this plugin with TNT, rename file to plugin_DEMO.m and set 
% 'type' to a correct value (1,2 or 3).
...
plugin.add_text('-- Variables with number types --','center','bold')
...
plugin.add_text('Some other variables','','','italic','Tooltip string')
