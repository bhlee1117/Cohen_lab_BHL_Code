...
% load(['E:\BACKUP\대학원\연구실\MY_Projects\HybriTrack\','colorset','.mat'])
...
% 
% 
% im=imread(['E:\BACKUP\대학원\연구실\MY_Projects\HybriTrack\Figure2_Bal\','MAX_Reslice of 20161005_dend_50ms_29-1_inverted','.tif']);
% subplot(3,1,1)
% imagesc(im')
% colormap('gray')
% hold all
...
% end
%         
% im=imread(['E:\BACKUP\대학원\연구실\MY_Projects\HybriTrack\Figure2_Bal\','20161005_dend_50ms_29-1_inverted','.tif'],65);
% subplot(3,1,2);
% colormap('gray')
% xlim([0,size(im,2)])
% ylim([0,size(im,1)])
...
% end
%          
% save(['E:\BACKUP\대학원\연구실\MY_Projects\HybriTrack\','TNT_track','.mat'],'track_bhl')
